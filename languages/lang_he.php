...
$lang = array(
	...
	"ques_table_empty" => "האם לרוקן טבלה '%s'?",
	"ques_table_drop" => "האם להשליך את הטבלה '%s'?",
	"ques_row_delete" => "האם למחוק שורות %s בטבלה '%s'?",
	"ques_database_delete" => "האם למחוק את מסד הנתונים '%s'?",
	"ques_column_delete" => "האם למחוק עמודות %s בטבלה '%s'?",
	"ques_index_delete" => "האם למחוק אינדקס '%s'?",
	"ques_trigger_delete" => "האם למחוק הדק '%s'?",
